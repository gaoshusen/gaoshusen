...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>' Records','prev'=>'Previous','next'=>'Next','first'=>'The first','last'=>'The last','theme'=>'%totalRow% %header% &nbsp;&nbsp;&nbsp; Page: %nowPage%/%totalPage%   &nbsp;&nbsp;%upPage% &nbsp;&nbsp;  %downPage% &nbsp;&nbsp; %first% &nbsp;&nbsp;  %prePage% &nbsp;&nbsp; %linkPage% &nbsp;&nbsp; %nextPage% &nbsp;&nbsp; %end%');
    // 默认分页变量名
    protected $varPage;
