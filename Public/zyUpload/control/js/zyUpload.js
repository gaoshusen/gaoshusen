		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				</div>';
		            html += '			</div>';
					html += '			<div id="preview" class="upload_preview" style="width:100%"></div>';
					html += '		</div>';
		            ...
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" class="upload_preview" style="width:100%">';
				    ...
				    html += '							<img class="upload_image" src="/Public/zyUpload/control/images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
...
//				}
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '图片说明：<br><textarea name="imgInfo[]" style="width:120px;height:30px;">'+file.name+'</textarea><br><input type="hidden" name="images[]" style="height:30px;" id="upname_'+file.index+'" value="">';
					html += '</div>';
					...
					html += '	<p id="uploadFailure_'+file.index+'" class="file_failure">上传失败，请重试</p>';
					html += '	<p id="uploadSuccess_'+file.index+'" class="file_success"></p>';
					//html += '图片说明：<textarea name="imgInfo[]" style="height:30px;">'+file.name+'</textarea>';
					html += '</div>';
				}
