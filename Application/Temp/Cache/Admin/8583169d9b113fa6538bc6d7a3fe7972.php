...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      <div class="">
                          <a onclick="addPacket();" href="javascript:void(0);" class="btn btn-primary ">发现金红包</a>
                      </div>
                      ...
                      <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTable">
                          <thead>
                              <tr>
                                  ...
                                  <th width="90">红包数</th>
                                  <th width="90">剩余个数</th>
                                  <th width="200">发包时间</th>
                                  <th width="80">操作</th>
                              </tr>
                          </thead>
                          <tbody>
                          
                              <?php if(is_array($packets)): $i = 0; $__LIST__ = $packets;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$P): $mod = ($i % 2 );++$i;?><tr class="gradeA">
                                  <td><?php echo ($P["ID"]); ?></td>       
                                  <td><?php echo ($P["title"]); ?></td>
                                  <td><?php echo ($P["money"]); ?></td>
                                  <td><?php echo ($P["nums"]); ?></td>  
                                  <td><?php echo ($P["mny_now"]); ?></td>  
                                  <td><?php echo (date("Y-m-d H:i:s",$P["stime"])); ?></td>  
                                  <td><a href="javascript:;" onclick="showPacket(<?php echo ($P["ID"]); ?>);">[查看详情]</a></td>
    ...
    function addPacket () {
      layer.open({
          type:2,
          title: ['发现金红包','background:#438EB9;color:#fff;'],
          content: "<?php echo U('givemny');?>",
    ...
    function showPacket (pid) {
      layer.open({
          type:2,
          title: ['红包详情','background:#438EB9;color:#fff;'],
          content: "<?php echo U('showmny');?>?pid="+pid,
