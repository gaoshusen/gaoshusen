                        ...
                        <form class="form-horizontal m-t" id="userForm" method="post">
                         ...
                         <!--   <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="col-sm-8">
                                        <textarea name="huifu" class="form-control" aria-required="true" style="height:120px;" ></textarea>
                                    </div>
                                </div>
                            </div>                          
                    ...
                    if (getStatu==0) 
                      ...
                      else
                      {
                        ...
                        layer.msg(result.info, {icon:1,time:300},function(){
                            ...
                            <?php else: ?>
                            parent.location.href="<?php echo U('cashlist');?>";<?php endif; ?>
                        });                        
                      };
                 }
             });
